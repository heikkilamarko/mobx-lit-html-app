...
import { validateRequired, validateAge, validateUsername, validateTags } from './validators';
...
export class FormStore {
	...
	get isValidating() {
		return this.isValidatingUsername || Object.values(this.fields).some((f) => f.isValidating);
	}
